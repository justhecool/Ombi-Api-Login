            ...
            sdk.isAuthorized(scope, function  (isAuthorized, apiData) {
                if (isAuthorized) {
                    console.log(apiData.user_id);
                                            console.log(apiData.signature);
                    if (apiData.user_id != 0 && window.xfacWpLogin != _undefined) {
                        // login
                       // history.pushState( '', 'Login', window.xfacWpLogin + '?id='+apiData.user_id);
                        window.location = window.xfacWpLogin + '&redirect_to=' + encodeURIComponent(location) + '&id='+apiData.user_id;
                    } else {
